...
console.log('1. Copy the database to your server:');
console.log(`   scp ${dbPath} root@YOUR_SERVER_IP:~/below-your-means/data/`);
console.log('');
console.log('2. Fix permissions on server:');
console.log('   ssh root@YOUR_SERVER_IP "chown 1001:1001 ~/below-your-means/data/belowyourmeans.db"');
console.log('');
